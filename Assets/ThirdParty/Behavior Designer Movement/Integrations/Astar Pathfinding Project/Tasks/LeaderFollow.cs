...
namespace BehaviorDesigner.Runtime.Tasks.Movement.AstarPathfindingProject
{
    ...
    public class LeaderFollow : IAstarAIGroupMovement
    {
        ...
        private Vector3 LeaderBehindPosition()
        {
            ...
            return leaderTransform.position + (-(prevLeaderPosition - leader.Value.transform.position)).normalized * leaderBehindDistance.Value;
        }
